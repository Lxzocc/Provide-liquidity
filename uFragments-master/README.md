...
[![Build Status](https://travis-ci.com/ProvideLiquidity/uFragments.svg?token=xxNsLhLrTiyG3pc78i5v&branch=master)](https://travis-ci.com/ProvideLiquidity/uFragments)&nbsp;&nbsp;[![Coverage Status](https://coveralls.io/repos/github/frgprotocol/uFragments/badge.svg?branch=master&t=GiWi8p)](https://coveralls.io/github/frgprotocol/uFragments?branch=master)

ProvideLiquidity (code name uFragments) is a decentralized elastic supply protocol. It maintains a stable unit price by adjusting supply directly to and from wallet holders. You can read the [whitepaper](https://www.ProvideLiquidity.org/paper/) for the motivation and a complete description of the protocol.

This repository is a collection of [smart contracts](http://ProvideLiquidity.org/docs) that implement the ProvideLiquidity protocol on the Ethereum blockchain.
...
For security issues, please contact dev-support@ProvideLiquidity.org.
